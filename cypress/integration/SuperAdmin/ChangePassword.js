...
describe("Change password Testcases", () => {
    ...
    it.only("As a Admin I should be able to navigate on change password screen", () => {
    ...
    it.only("At Chnage Password page each page should have proper labels", () => {
    ...
    it.only('Validate "Change Password" section with Blank Data.', () => {
    ...
    it.only('Validate "Change Password" section with invalid Data.', () => {
    ...
    it.only("Validate 'Change Password' section with Minimum Characters.", () => {
